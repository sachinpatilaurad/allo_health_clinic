...
const create_queue_patient_dto_1 = require("./dto/create-queue-patient.dto");
...
let QueueController = class QueueController {
    ...
    create(createQueuePatientDto) {
        return this.queueService.create(createQueuePatientDto);
    }
    findAll() {
        return this.queueService.findAll();
    }
    updateStatus(id, updateQueueStatusDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_queue_patient_dto_1.CreateQueuePatientDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_queue_status_dto_1.UpdateQueueStatusDto]),
    __metadata("design:returntype", void 0)
